...
const Card = ({ posterPath, title, popularity, releaseDate, id, navigation, mediaType }) => {
      ...
      <HStack space={4}>
        <Box style={styles.imageContainer}>
          <TouchableOpacity onPress={handleImageClick}>
            <Image alt={title.length > 17 ? `${title.slice(0, 17)}...` : title} source={{ uri: imageUrl }} size="xl" />
          </TouchableOpacity>
        </Box>
